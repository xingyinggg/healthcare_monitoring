      ...
      tooltip: {
        ...
        callbacks: {
          ...
          label: function(context) {
            const unit = title.includes('Heart Rate') ? ' bpm' :
                        title.includes('Blood Pressure') ? ' mmHg' :
                        title.includes('SpO2') || title.includes('SpO₂') ? '%' :
                        title.includes('Respiratory') ? ' bpm' :
                        title.includes('Activity') ? ' steps' : '';
