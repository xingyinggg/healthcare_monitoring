            ...
            {patients.map((patient, index) => (
              ...
              >
                ...
                <td className="table-cell">
                  <div className="flex items-center">
                    <span
                      className={`text-lg font-bold ${getVitalStatus("heartRate", patient.heartRate, "heartRate")}`}
                    >
                      {patient.heartRate || "--"}
                    </span>
                ...
                <td className="table-cell">
                  <div className="flex items-center">
                    <span
                      className={`text-lg font-bold ${getVitalStatus("bloodPressure", patient.bloodPressure, "bloodPressure")}`}
                    >
                ...
                <td className="table-cell">
                  <div className="flex items-center">
                    <span
                      className={`text-lg font-bold ${getVitalStatus("respiratoryRate", patient.respiratoryRate, "respiratoryRate")}`}
                    >
                ...
                <td className="table-cell">
                  <div className="flex items-center">
                    <span
                      className={`text-lg font-bold ${getVitalStatus("activityLevel", patient.activityLevel, "activityLevel")}`}
                    >
